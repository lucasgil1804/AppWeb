...
<div class="container">
             ...
             <!-- Campo oculto utilizado para el metodo EnReparacio() -->
              ...
              <!-- Campo oculto utilizado para el metodo EnReparacio() -->
                <form method="POST" action="{{ url('updateReparacion/'. $reparacion->id_reparacion) }}">
    				...
    				<div style="display: inline-block; float: right; margin-bottom: 15px; width: 70px;">
    ...
    <div id="mobile2" class="alert alert-info mb-3 mx-3">
        No es posible visualizar la sección <strong>Editar</strong> desde la vista móvil. Por favor ingrese desde un dispositivo con mayor resolución.
    </div>
</div>

...
@section('contenidoApp')
	@if(Session::has('form_enviado'))
		<!-- The Modal -->
		<div class="modal" tabindex="-1" role="dialog" id="miModal">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Consulta Enviada</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<p>{{Session::get('form_enviado')}} <strong>Muchas gracias por comunicarse con nosotros</strong></p>
			</div>
	...
	<section class="contact-page-area section-gap">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8">
					<form class="form-area " action="{{url('enviarConsulta')}}" method="post" class="contact-form text-right">
						{{csrf_field()}}
						<div class="row">	
							...
							<div class="col-lg-12">
								...
								<button type="submit" class="genric-btn success circle" style="float: right;">Enviar</button>											
							</div>
						</div>
					</form>	
				</div>
